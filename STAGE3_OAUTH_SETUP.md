...
3. Fill in:
   ...
   - **Redirect URLs:** `https://vguardus.com/api/oauth/vercel/callback`
...
echo "https://vguardus.com" | npx vercel env add VGUARD_PUBLIC_ORIGIN production
...
```bash
curl -I "https://vguardus.com/api/oauth/vercel/start?domain=<DOMAIN>&uuid=vs-test-1234567890123456"
```
