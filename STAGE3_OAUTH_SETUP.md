...
3. Fill in:
   ...
   - **Redirect URLs:** `https://v-guards.com/api/oauth/vercel/callback`
...
echo "https://v-guards.com" | npx vercel env add VGUARD_PUBLIC_ORIGIN production
...
```bash
curl -I "https://v-guards.com/api/oauth/vercel/start?domain=<DOMAIN>&uuid=vs-test-1234567890123456"
```
